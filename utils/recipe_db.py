...
RECIPES: dict[str, dict[str, dict]] = {
    ...
    "Aluminum Scrap": {
        "default": {
            ...
            "outputs": {"Aluminum Scrap": 360.0, "Water": 120.0},
            "alternate": False,
            "schematic": None,
        },
        "best": {
            ...
            "outputs": {"Aluminum Scrap": 300.0, "Water": 105.0},
            "alternate": True,
    ...
    "Dark Matter Crystal": {
        ...
        "best": {
            ...
            "inputs": {"Time Crystal": 30.0, "Dark Matter Residue": 150.0},
            "outputs": {"Dark Matter Crystal": 60.0},
            "alternate": True,
    ...
    "Neural-Quantum Processor": {
        "default": {
            # Quantum Encoder, 20s cycle → 1 unit (3/min)
            ...
            "outputs": {"Neural-Quantum Processor": 3.0, "Dark Matter Residue": 75.0},
            "alternate": False,
            "schematic": None,
        },
        "best": {
    ...
    "AI Expansion Server": {
        "default": {
            ...
            "outputs": {"AI Expansion Server": 4.0, "Dark Matter Residue": 100.0},
            "alternate": False,
            "schematic": None,
        },
        "best": {
